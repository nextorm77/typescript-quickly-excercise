...
var pendingTransactionsEl = document.getElementById('pending-transactions');
...
(function main() {
    return __awaiter(this, void 0, void 0, function () {
        function addTransaction() {
            ...
            pendingTransactionsEl.textContent = blockchain.pendingTransactions.map(function (t) {
                return t.sender + " \u2192 " + t.recipient + ": $" + t.amount;
            }).join('\n');
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            blocksEl.innerHTML = blockchain.chain.map(function (b, i) { return generateBlockHtml(b, i); }).join('');
