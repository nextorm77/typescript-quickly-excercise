...
var universal_sha256_js_1 = require("./universal_sha256.js");
    ...
    Block.prototype.calculateHash = function (nonce) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = this.previousHash + this.timestamp + JSON.stringify(this.transactions) + nonce;
                return [2 /*return*/, universal_sha256_js_1.sha256(data)];
            });
        });
    };
    return Block;
...
var Blockchain = /** @class */ (function () {
    ...
    Object.defineProperty(Blockchain.prototype, "chain", {
        get: function () {
            return __spreadArrays(this._chain);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Blockchain.prototype, "pendingTransactions", {
        get: function () {
            return __spreadArrays(this._pendingTransactions);
        },
        enumerable: false,
        configurable: true
    });
